...
{
    public partial class Paketleme_Saved_Eklendi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "Paketleme_Maliyeti_Saved_Rows",
                columns: table => new
                {
                    ...
                    Paketleme_Maliyeti_Saved_Id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Paketleme_Maliyeti_Saved_Rows", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Paketleme_Maliyeti_Saveds",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Paketleme_Maliyeti_Saveds", x => x.Id);
                });
        }
