...
namespace WebApi.Services
{
    public interface IUserService
    {
        ...
        List<User> Get_Users_WOP();

        User Get_Users_WP(User x);

        User Change_Password(RegisterRequest request);
        User Update_User(User request);
        User Get_By_Id_User(UserTanıma request);
    }
    ...
    public class UserService : IUserService
    {
        ...
        public User createUser(RegisterRequest request)
        {
            ...
            {
                new User {  FirstName = request.FirsName,
        ...
        public User Get_By_Id_User(UserTanıma request)
        {
            // context.User.Claims.FirstOrDefault(o =>o.Value=="id");
            var tokenHandler = new JwtSecurityTokenHandler();
            var Token = (JwtSecurityToken)tokenHandler.ReadJwtToken(request.Token);
        ...
        public User Change_Password(RegisterRequest request)
        {
